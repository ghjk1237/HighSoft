...
<div class="bjui-pageContent">
    <form id="addrole" action="<%=request.getContextPath()%>/system/role/roleAction!add.action" class="pageForm" data-toggle="validate"
        data-callback="submit">
        <table class="table table-condensed table-hover">
            <tbody>
                <tr>
                    <td colspan="2" align="center"><h2>添加系统角色</h2></td>
                </tr>
                <tr>
                    <td>
