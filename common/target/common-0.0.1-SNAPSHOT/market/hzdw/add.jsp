...
<div class="bjui-pageContent">
    <form id="market_group_add" action="<%=request.getContextPath()%>/market/hzdw/coworkCompAction!add.action" class="pageForm" data-toggle="validate"
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="beginDate" id="dialog_ksrq" data-toggle="datepicker" data-rule="required" size="16">
                    </td>
                </tr>
                <tr>
                	<td>
